@extends('layouts.default')
    ...
    @section('meta')
        <title>Edit Employee Profile | CK Tech Media</title>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <form style="background-color:#b0e0e6" id="edit_employee_form" action="{{ url('profile/update') }}" class="ui form custom" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                @csrf
                <div class="col-md-6 float-left">
                    <div class="box box-success">
                        <div class="box-header with-border" style="color:red">{{ __('Personal Information') }}</div>
                        <div class="box-body">
                            ...
                            <div class="two fields">
                                <div class="field">
                                    <label>{{ __('Father/Husband Name') }} <span class="help"></span></label>
                                    <input type="text" name="height" value="@isset($person_details->height){{ $person_details->height }}@endisset" placeholder="">
                                </div>
                                <div class="field">
                                    <label>{{ __('Relation') }} <span class="help"></span></label>
                                    <input type="text" name="weight" value="@isset($person_details->weight){{ $person_details->weight }}@endisset" placeholder="">
                                </div>
                            </div>
                            <div class="two fields">
                            <div class="field">
                ...
                <div class="col-md-6 float-left">
                    <div class="box box-success">
                        <div class="box-header with-border" style="color:red">{{ __('Employee Details') }}</div>
                        <div class="box-body">
                            ...
                            <h4 class="ui dividing header" style="color:red">{{ __('Employment Information') }}</h4>
                            <div class="field">
