    ...
    <div class="container-fluid">
        ...
        <div class="row columnview">
            ...
            <div class="col-md-6 colview">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ __("Company Population") }}</h3>
                    </div>
                    <div class="box-body">
            ...
            <div class="colview col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ __("Department Population") }}</h3>
                    </div>
                    <div class="box-body">
                        <div class="canvas-wrapper">
            ...
            <div class="colview col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ __("Civil Status Demographics") }}</h3>
                    </div>
                    <div class="box-body">
                        <div class="canvas-wrapper">
            ...
            <div class="colview col-md-6">
                <div class="box box-success">
                    <div class="box-header with-border">
                        <h3 class="box-title">{{ __("Employee Hired by Year") }}</h3>
                    </div>
                    <div class="box-body">
                        <div class="canvas-wrapper">
