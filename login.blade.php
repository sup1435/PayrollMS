...
<head>
	<title>Sign in | CK Tech Media</title>
	<meta charset="utf-8">
	<meta http-equiv="X-UA-Compatible" content="IE=edge, chrome=1">
	<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<link rel="icon" type="image/png" sizes="32x32" href="{{ asset('/assets/images/img/ck8.png') }}">
	<link rel="icon" type="image/png" sizes="16x16" href="{{ asset('/assets/images/img/ck8.png') }}">
	<link rel="icon" type="image/x-icon" href="{{ asset('/assets/images/img/ck8.png') }}">
		...
		<div class="vertical-align-wrap">
			<div class="vertical-align-middle">
				<div class="auth-box">
					<div class="content">
						<div class="header">
							<div class="logo align-center"><img src="{{ asset('/assets/images/img/ck7.png') }}" alt="Workday" height="100" width="400"></div>
						...
						<form class="form-auth-small ui form" action="{{ route('login') }}" method="POST">
							...
							<button type="submit" class="ui blue button large fluid">{{ __('SIGN IN') }}</button>
						</form>
					</div>
				</div>
			</div>
