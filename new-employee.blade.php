@extends('layouts.default')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <form style="background-color:#b0e0e6" id="add_employee_form" action="{{ url('employee/add') }}" class="ui form custom" method="post" accept-charset="utf-8" enctype="multipart/form-data">
            @csrf
