@extends('layouts.default')
    ...
    @section('meta')
        <title>Profile | CK Tech Media</title>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-8 float-left">
                <div class="box box-success">
                    <div class="box-header with-border" style="color:blue">{{ __('Personal Information') }}</div>
                    <div class="box-body employee-info">
                            <table class="tablelist">
                                <tbody>
                                    ...
                                    <tr>
                                        <td><p>{{ __('Father/Husband Name') }} <span class="help"></span></p></td>
                                        <td><p>@isset($p->height) {{ $p->height }} @endisset</p></td>
                                    </tr>
                                    <tr>
                                        <td><p>{{ __('Relation') }} <span class="help"></span></p></td>
                                    ...
                                    <tr>
                                        <td><p>{{ __('Nationality') }}</p></td>
                                        <td><p>@isset($p->nationalid) {{ $p->nationalid }} @endisset</p></td>
                                    </tr>
                                    <tr>
                                        <td colspan="2">
                                            <h4 class="ui dividing header" style="color:blue">{{ __('Designation') }}</h4>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>{{ __('Company') }}</td>
