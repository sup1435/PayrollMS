...
<link rel="stylesheet" href="https://www.w3schools.com/w3css/4/w3.css">
    @section('meta')
        <title>My Dashboard | CK Tech Media</title>
    ...
    @section('content')
        ...
        <div class="row">
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="info-box w3-center w3-animate-right">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text bolder"><span class="uppercase">{{ __("Attendance (Current Month)") }}</span></span>
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="info-box w3-center w3-animate-right">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text bolder">{{ __("Present Schedule") }}</span>
                        <div class="progress-group">
                            <div class="progress sm">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="info-box w3-center w3-animate-right">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text uppercase bolder">{{ __("Leaves of Absence") }}</span>
                        <div class="progress-group">
                            <div class="progress sm">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="box box-success w3-center w3-animate-bottom">
                    <div class="box-header with-border" style="background-color:powderblue;">
                        <h3 class="box-title" style="text-align:center;color:black;">{{ __("Previous Schedules") }}</h3>
                        <div class="box-tools pull-right">
                            <button type="button" class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                        </div>
                    </div>
